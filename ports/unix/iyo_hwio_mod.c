...
STATIC mp_obj_t mod_iyo_hwio_add_aes67_transmit_flow(mp_obj_t session_name, mp_obj_t base_ch_idx, mp_obj_t channel_count) {
    int r = hwioc_add_aes67_transmit_flow(mp_obj_str_get_str(session_name), mp_obj_get_int(base_ch_idx), mp_obj_get_int(channel_count));
...
STATIC mp_obj_t mod_iyo_hwio_delete_aes67_transmit_flow(mp_obj_t session_name) {
    int r = hwioc_delete_aes67_transmit_flow(mp_obj_str_get_str(session_name));
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_iyo_hwio_delete_aes67_transmit_flow_obj, mod_iyo_hwio_delete_aes67_transmit_flow);
...
STATIC mp_obj_t mod_iyo_hwio_get_aes67_enabled(void) {
    int r = hwioc_get_aes67_enabled();

    if (r < 0) {
        mp_raise_OSError(-r);
    }

    return MP_OBJ_FROM_PTR(mp_obj_new_int(r));
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_iyo_hwio_get_aes67_enabled_obj, mod_iyo_hwio_get_aes67_enabled);
...
STATIC mp_obj_t mod_iyo_hwio_get_ip_address(void) {
    uint8_t * ip = hwioc_get_ip_address_bytes();
    if (!ip) {
        mp_raise_OSError(-1);
    }
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_iyo_hwio_get_ip_address_obj, mod_iyo_hwio_get_ip_address);
...
STATIC mp_obj_t mod_iyo_hwio_get_tx_ch_aes67_flow_channel(mp_obj_t index) {
    int flow_channel = hwioc_get_tx_ch_aes67_flow_channel(mp_obj_get_int(index));
    if (flow_channel < 0) {
        mp_raise_OSError(-1);
    }

    return MP_OBJ_FROM_PTR(mp_obj_new_int(flow_channel));
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_iyo_hwio_get_tx_ch_aes67_flow_channel_obj, mod_iyo_hwio_get_tx_ch_aes67_flow_channel);
...
STATIC const mp_rom_map_elem_t mp_module_iyo_hwio_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_get_aes67_enabled), MP_ROM_PTR(&mod_iyo_hwio_get_aes67_enabled_obj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_get_ip_address), MP_ROM_PTR(&mod_iyo_hwio_get_ip_address_obj) },
